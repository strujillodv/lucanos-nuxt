  ...
  section
    v-parallax(
      ...
      v-row.mx-auto(
        ...
        h1.text-h2.text-md-h1 Educación y asesoría en Blockchain
    v-container
      v-row(
        no-gutters
        aling="center"
